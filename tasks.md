...
- [x] **P3-03 实现 Smart Update Hash**
  - 对输入内容、设置、工具版本和导出器版本生成哈希。
  - 状态未变化时跳过编码和文件写入。
  - 支持强制发布选项。

- [x] **P3-04 提供 CI 和 Docker 工作流**
