...
export const translations = {
  en: {
    ...
    inspector: {
      ...
      trimRect: 'Rectangle',
      trimPolygon: 'Polygon',
      polygonTolerance: 'Polygon tolerance',
      backgroundColor: 'Background color',
      transparent: 'Transparent',
    ...
    publish: {
      ...
      cancel: 'Cancel',
      publish: 'Publish',
      legend: '{name}=root · {n}=sheet · {suffix}=@2x/@0.5x · {ext}=extension',
      preview: 'Preview',
  ...
  zh: {
    ...
    publish: {
      ...
      cancel: '取消',
      publish: '发布',
      legend: '{name}=根 · {n}=张序号 · {suffix}=@2x/@0.5x · {ext}=后缀名',
      preview: '预览',
      publishing: '正在发布…',
      done: '已发布 {n} 个文件',
